...
const _meta = getTemplateMetadata("random-wire");
...
export const randomWireTemplate: AntennaTemplate = {
  ...
  generateGeometry(params: Record<string, number>): WireGeometry[] {
    ...
    const horizontalRun = Math.sqrt(Math.max(0, wireLength * wireLength - heightDelta * heightDelta));
    ...
    return [
      { tag: 1, segments: mainSegs, x1: 0, y1: 0, z1: feedHeight, x2: horizontalRun, y2: 0, z2: farEndHeight, radius },
